...
Ecological dynamics in ternary — Lotka-Volterra, food webs, population cycles, and ecosystem stability
...
pub fn lotka_volterra_2species
```
...
```bash
git clone https://github.com/SuperInstance/ternary-ecology.git
cd ternary-ecology
cargo test    # 13 tests
```
